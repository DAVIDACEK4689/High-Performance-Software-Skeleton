...
namespace dcnnmain {
    static fmwkng::gold_pair gr_1()
    {
        ...
        rv.value.push_back(std::make_unique<fmwkng::impl::element_t<dcnnmain::loss,fmwkng::impl::element_sense::CLOSE>>(75U));
        return rv;
    }
    ...
    static fmwkng::gold_pair gr_1_1_1_1_1_1_2()
    {
        ...
        rv.value.push_back(std::make_unique<fmwkng::impl::element_t<dcnnmain::loss,fmwkng::impl::element_sense::CLOSE>>(70U));
        return rv;
    }
    static fmwkng::gold_pair gr_1_1_1_1_1_1_3()
    {
        ...
        rv.value.push_back(std::make_unique<fmwkng::impl::element_t<dcnnmain::loss,fmwkng::impl::element_sense::CLOSE>>(74U));
        return rv;
    }
    static fmwkng::gold_pair gr_1_1_1_1_1_1_4()
    {
        ...
        rv.value.push_back(std::make_unique<fmwkng::impl::element_t<dcnnmain::loss,fmwkng::impl::element_sense::CLOSE>>(73U));
        return rv;
    }
    ...
    static fmwkng::gold_pair gr_1_1_1_1_1_1_8()
    {
        ...
        rv.value.push_back(std::make_unique<fmwkng::impl::element_t<dcnnmain::loss,fmwkng::impl::element_sense::CLOSE>>(71U));
        return rv;
    }
